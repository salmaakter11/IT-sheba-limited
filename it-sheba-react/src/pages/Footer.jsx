                        ...
                        <div className="row">
                                ...
                                <div className="footer-nav-wrap text-white">
                                    ...
                                    <ul className="nav flex-column">
                                        <li className="nav-item">
                                            <a className="nav-link" href="Company-profile.html">Company-profile</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="Messege-founder.html">Founder Messege</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="Payment-system.html">Payment System</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="our-clients.html">Our Clients</a>
                                        </li>
                                    </ul>
                            ...
                            <div className="col-md-3 col-sm-6">
                                <div className="footer-nav-wrap text-white">
                                    ...
                                    <ul className="nav flex-column">
                                        <li className="nav-item">
                                            <a className="nav-link" href="Web-development.html">Web Development</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="">Software Development</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="Email-marketing.html">Email Marketing</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="domain.html">Domain / Hosting</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="nav-link" href="whatsapp-marketing.html">WhatsApp Marketing</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div className="col-md-3 col-sm-6">
                                <div className="footer-nav-wrap text-white">
                                    ...
                                    <ul className="nav flex-column">
                                        <li className="nav-item">
                                            <a className="nav-link" href="#"><span className="fas fa-location mr-2"></span> Mukto Bangla
